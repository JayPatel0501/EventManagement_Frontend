...
export class EventInfoComponent implements OnInit {
  ...
  OnUpdateActivity(activity: ActivityInfo) {
    console.log("update activity")
    this.selectedActivity = activity;
    this.selecttedOpration = "UpdateActivity";
  }

  constructor(private route: ActivatedRoute, private activityService: ActivityServiecService, private eventService: EventService, private router: Router) {
